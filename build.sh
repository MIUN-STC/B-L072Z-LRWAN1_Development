set -x #echo on
arm-none-eabi-gcc -c -mcpu=cortex-m0plus -mthumb -Og -Wall -fdata-sections -ffunction-sections -g -gdwarf-2 -MMD -MP -MF"build/aes.d" -MT"build/aes.d" -Wa,-a,-ad,-alms=build/aes.lst src/aes.c -o build/aes.o
...
arm-none-eabi-gcc build/startup_stm32l072xx.o build/aes.o build/main.o -mcpu=cortex-m0plus -mthumb -specs=nano.specs -Tsrc/STM32L072CZEx_FLASH.ld  -lc -lm -lnosys -Wl,-Map=build/main.map,--cref -Wl,--gc-sections -o build/main.elf
