...
{
  //TODO: Find out why this needed for making RFLR_IRQFLAGS_TXDONE set after transmit.
  ...
  GPIO_Pin_Mode (RADIO_DIO0_PORT, RADIO_DIO0_PIN, RADIO_DIO0_PIN_MODE);
  GPIO_Pin_Pull (RADIO_DIO0_PORT, RADIO_DIO0_PIN, RADIO_DIO0_PIN_PULL);
  GPIO_Pin_Speed (RADIO_DIO0_PORT, RADIO_DIO0_PIN, RADIO_DIO0_PIN_SPEED);
  GPIO_Pin_Clear (RADIO_DIO0_PORT, RADIO_DIO0_PIN);
  ...
  GPIO_Pin_Speed (RADIO_DIO1_PORT, RADIO_DIO1_PIN, RADIO_DIO1_PIN_SPEED);
  GPIO_Pin_Clear (RADIO_DIO1_PORT, RADIO_DIO1_PIN);
  ...
  GPIO_Pin_Speed (RADIO_DIO2_PORT, RADIO_DIO2_PIN, RADIO_DIO2_PIN_SPEED);
  GPIO_Pin_Clear (RADIO_DIO2_PORT, RADIO_DIO2_PIN);
  ...
  GPIO_Pin_Speed (RADIO_DIO3_PORT, RADIO_DIO3_PIN, RADIO_DIO3_PIN_SPEED);
  GPIO_Pin_Clear (RADIO_DIO3_PORT, RADIO_DIO3_PIN);
